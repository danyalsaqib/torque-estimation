...
torque_msgs__msg__ExpandedJointStates__init(torque_msgs__msg__ExpandedJointStates * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    torque_msgs__msg__ExpandedJointStates__fini(msg);
    return false;
  }
  // name
...
torque_msgs__msg__ExpandedJointStates__create()
{
  ...
  torque_msgs__msg__ExpandedJointStates * msg = (torque_msgs__msg__ExpandedJointStates *)allocator.allocate(sizeof(torque_msgs__msg__ExpandedJointStates), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(torque_msgs__msg__ExpandedJointStates));
  bool success = torque_msgs__msg__ExpandedJointStates__init(msg);
  if (!success) {
...
torque_msgs__msg__ExpandedJointStates__Sequence__init(torque_msgs__msg__ExpandedJointStates__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  torque_msgs__msg__ExpandedJointStates * data = NULL;

  if (size) {
    data = (torque_msgs__msg__ExpandedJointStates *)allocator.zero_allocate(size, sizeof(torque_msgs__msg__ExpandedJointStates), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = torque_msgs__msg__ExpandedJointStates__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        torque_msgs__msg__ExpandedJointStates__fini(&data[i - 1]);
      }
...
torque_msgs__msg__ExpandedJointStates__Sequence__fini(torque_msgs__msg__ExpandedJointStates__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      torque_msgs__msg__ExpandedJointStates__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  torque_msgs__msg__ExpandedJointStates__Sequence * array = (torque_msgs__msg__ExpandedJointStates__Sequence *)allocator.allocate(sizeof(torque_msgs__msg__ExpandedJointStates__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = torque_msgs__msg__ExpandedJointStates__Sequence__init(array, size);
  if (!success) {
...
torque_msgs__msg__ExpandedJointStates__Sequence__destroy(torque_msgs__msg__ExpandedJointStates__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    torque_msgs__msg__ExpandedJointStates__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
torque_msgs__msg__ExpandedJointStates__Sequence__are_equal(const torque_msgs__msg__ExpandedJointStates__Sequence * lhs, const torque_msgs__msg__ExpandedJointStates__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!torque_msgs__msg__ExpandedJointStates__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  torque_msgs__msg__ExpandedJointStates__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(torque_msgs__msg__ExpandedJointStates);
    torque_msgs__msg__ExpandedJointStates * data =
      (torque_msgs__msg__ExpandedJointStates *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!torque_msgs__msg__ExpandedJointStates__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          torque_msgs__msg__ExpandedJointStates__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!torque_msgs__msg__ExpandedJointStates__copy(
