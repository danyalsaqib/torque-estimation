...
bool torque_msgs__msg__expanded_joint_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("torque_msgs.msg._expanded_joint_state.ExpandedJointState", full_classname_dest, 56) == 0);
  }
  torque_msgs__msg__ExpandedJointState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ExpandedJointState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("torque_msgs.msg._expanded_joint_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExpandedJointState");
