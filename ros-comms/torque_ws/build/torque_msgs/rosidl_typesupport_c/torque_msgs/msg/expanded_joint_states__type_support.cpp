...
static const _ExpandedJointStates_type_support_symbol_names_t _ExpandedJointStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, torque_msgs, msg, ExpandedJointStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, torque_msgs, msg, ExpandedJointStates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, torque_msgs, msg, ExpandedJointStates)() {
  return &::torque_msgs::msg::rosidl_typesupport_c::ExpandedJointStates_message_type_support_handle;
}
