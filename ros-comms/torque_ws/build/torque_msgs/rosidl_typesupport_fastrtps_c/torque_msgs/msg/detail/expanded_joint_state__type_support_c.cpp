...
#include "torque_msgs/msg/detail/expanded_joint_state__rosidl_typesupport_fastrtps_c.h"
...
#include "torque_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_torque_msgs
...
using _ExpandedJointState__ros_msg_type = torque_msgs__msg__ExpandedJointState;

static bool _ExpandedJointState__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ExpandedJointState__ros_msg_type * ros_message = static_cast<const _ExpandedJointState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _ExpandedJointState__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ExpandedJointState__ros_msg_type * ros_message = static_cast<_ExpandedJointState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_torque_msgs
size_t get_serialized_size_torque_msgs__msg__ExpandedJointState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExpandedJointState__ros_msg_type * ros_message = static_cast<const _ExpandedJointState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ExpandedJointState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_torque_msgs__msg__ExpandedJointState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_torque_msgs
size_t max_serialized_size_torque_msgs__msg__ExpandedJointState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _ExpandedJointState__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_torque_msgs__msg__ExpandedJointState(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ExpandedJointState = {
  "torque_msgs::msg",
  "ExpandedJointState",
  _ExpandedJointState__cdr_serialize,
  _ExpandedJointState__cdr_deserialize,
  _ExpandedJointState__get_serialized_size,
  _ExpandedJointState__max_serialized_size
};

static rosidl_message_type_support_t _ExpandedJointState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ExpandedJointState,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, torque_msgs, msg, ExpandedJointState)() {
  return &_ExpandedJointState__type_support;
}
