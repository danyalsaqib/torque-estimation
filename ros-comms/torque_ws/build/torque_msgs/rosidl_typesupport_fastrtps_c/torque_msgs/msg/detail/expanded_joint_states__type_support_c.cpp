...
#include "torque_msgs/msg/detail/expanded_joint_states__rosidl_typesupport_fastrtps_c.h"
...
using _ExpandedJointStates__ros_msg_type = torque_msgs__msg__ExpandedJointStates;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ExpandedJointStates__ros_msg_type * ros_message = static_cast<const _ExpandedJointStates__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ExpandedJointStates__ros_msg_type * ros_message = static_cast<_ExpandedJointStates__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_torque_msgs__msg__ExpandedJointStates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExpandedJointStates__ros_msg_type * ros_message = static_cast<const _ExpandedJointStates__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ExpandedJointStates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_torque_msgs__msg__ExpandedJointStates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_torque_msgs
size_t max_serialized_size_torque_msgs__msg__ExpandedJointStates(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_torque_msgs__msg__ExpandedJointStates(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ExpandedJointStates = {
  "torque_msgs::msg",
  "ExpandedJointStates",
...
static rosidl_message_type_support_t _ExpandedJointStates__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ExpandedJointStates,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, torque_msgs, msg, ExpandedJointStates)() {
  return &_ExpandedJointStates__type_support;
}
