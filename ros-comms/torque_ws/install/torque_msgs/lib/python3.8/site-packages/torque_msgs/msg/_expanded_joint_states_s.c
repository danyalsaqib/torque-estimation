...
bool torque_msgs__msg__expanded_joint_states__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("torque_msgs.msg._expanded_joint_states.ExpandedJointStates", full_classname_dest, 58) == 0);
  }
  torque_msgs__msg__ExpandedJointStates * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * torque_msgs__msg__expanded_joint_states__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ExpandedJointStates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("torque_msgs.msg._expanded_joint_states");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExpandedJointStates");
  ...
  torque_msgs__msg__ExpandedJointStates * ros_message = (torque_msgs__msg__ExpandedJointStates *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
